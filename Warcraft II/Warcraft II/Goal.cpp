		...
		case EntityType_ELVEN_ARCHER:
...

			{
				...
				case UnitDirection_DownRight:
					App->particles->AddParticle(App->particles->playerArrows.downRight, { (int)owner->GetPos().x + 16, (int)owner->GetPos().y + 16 }, targetTile, elvenArcher->GetArrowSpeed(), owner->GetDamage());
					break;
				case UnitDirection_UpRight:
					App->particles->AddParticle(App->particles->playerArrows.upRight, { (int)owner->GetPos().x + 16, (int)owner->GetPos().y - 16 }, targetTile, elvenArcher->GetArrowSpeed(), owner->GetDamage());
					break;
				case UnitDirection_Right:
					App->particles->AddParticle(App->particles->playerArrows.right, { (int)owner->GetPos().x + 16, (int)owner->GetPos().y }, targetTile, elvenArcher->GetArrowSpeed(), owner->GetDamage());
					break;
				case UnitDirection_DownLeft:
					App->particles->AddParticle(App->particles->playerArrows.downLeft, { (int)owner->GetPos().x - 16, (int)owner->GetPos().y + 16 }, targetTile, elvenArcher->GetArrowSpeed(), owner->GetDamage());
					break;
				case UnitDirection_UpLeft:
					App->particles->AddParticle(App->particles->playerArrows.upLeft, { (int)owner->GetPos().x - 16, (int)owner->GetPos().y - 16 }, targetTile, elvenArcher->GetArrowSpeed(), owner->GetDamage());
					break;
				case UnitDirection_Left:
					App->particles->AddParticle(App->particles->playerArrows.left, { (int)owner->GetPos().x - 16, (int)owner->GetPos().y }, targetTile, elvenArcher->GetArrowSpeed(), owner->GetDamage());
					break;
				case UnitDirection_Down:
					App->particles->AddParticle(App->particles->playerArrows.down, { (int)owner->GetPos().x, (int)owner->GetPos().y + 16 }, targetTile, elvenArcher->GetArrowSpeed(), owner->GetDamage());
					break;

				case UnitDirection_Up:
				case UnitDirection_NoDirection:
				default:
					App->particles->AddParticle(App->particles->playerArrows.up, { (int)owner->GetPos().x, (int)owner->GetPos().y - 16 }, targetTile, elvenArcher->GetArrowSpeed(), owner->GetDamage());
					break;
				}
			}
			break;
